...
const ProductCard = React.memo(({ product, addToCart, index }) => {
  ...
  return (
    <Link href={`/product/${product.id}`}>
      <Card
        className="group will-change-transform overflow-hidden border border-transparent hover:border-[#FF6B35] transition-all duration-300 hover:shadow-md"
